                ...
                this.channels = [ {
                    ...
                    channels_arr : [ {
                        ...
                        sub : [ {
                            ...
                            name : "时装名录",
                            code : "fashion_brand",
                            filter : "ga:pagePath=~/product/fashion/*;ga:hostname==brand.self.com.cn"
                        }, {
                            name : "时装学院",
                        ...
                        sub : [ {
                            ...
                            name : "悦己宠物",
                            code : "life_pets",
                            filter : "ga:pagePath=~/pets/*;ga:hostname==life.self.com.cn"
                        }, {
                            name : "公益",
                            code : "life_charity",
                        ...
                        sub : [ {
                            ...
                            name : "化妆品库",
                            code : "beauty_brands",
                            filter : "ga:pagePath=~/product/cosmetics/*;ga:hostname==brand.self.com.cn"
                        }, {
                            name : "美容365",
                            code : "beauty_b365",
